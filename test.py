...
class DriverMonitoringSystem:
    ...
    def _setup_flask_app(self):
        ...
        def emergency_map():
            ...
            try:
                return render_template('azure_map.py')
    ...
    def start_emergency_web_server(self):
        """Start Flask web server for emergency interface"""
        if self.flask_server_running:
            print("🌐 Emergency web server already running")
            return
        
        try:
            # Check if static folder and HTML file exist
            static_path = Path('static')
            html_file = static_path / 'azure_map.py'
            ...
            # Open browser to emergency page
    ...
    def trigger_alert(self, state):
        ...
        if state.consciousness_level in alert_states:
            ...
            if state.consciousness_level == "UNCONSCIOUS":
                ...
                self.start_emergency_web_server()
...
def main():
    ...
    print("🚗 Driver Monitoring System - MediaPipe Edition")
    print("=" * 50)
    print("✅ No external model files required!")
